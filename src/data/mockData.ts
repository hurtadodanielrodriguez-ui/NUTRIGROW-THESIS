...
export const INITIAL_USER: UserProfile = {
  ...
  bio: 'Apasionada de la nutrición consciente, los superalimentos y la jardinería de microgreens en casa.',
  goal: 'salud_integral',
...
export const INITIAL_RECIPES: Recipe[] = [
  ...
  {
    id: 'rec_10',
    title: 'Omelette Botánico con Espinacas Baby, Champiñones & Feta',
    category: 'desayunos',
    categoryLabel: 'Desayunos Energéticos',
    prepTimeMinutes: 12,
    calories: 290,
  ...
  {
    id: 'rec_17',
    title: 'Hamburguesa Botánica de Lentejas & Setas con Brotes Vivos',
    category: 'cenas',
    categoryLabel: 'Cenas Ligeras',
    prepTimeMinutes: 25,
    calories: 340,
    ...
    tags: ['Plant-Based', 'Rico en Fibra', 'Proteína Botánica'],
    rating: 4.9,
    reviewsCount: 135,
    isFavorite: false
  },
...
export const INITIAL_TESTIMONIALS: Testimonial[] = [
  {
    ...
    comment: 'NutriGrow no es otra app de contar calorías vacías. Integra la botánica viva, el autocultivo y la nutrición antiinflamatoria de una manera tan armoniosa y elegante que la recomiendo a todos mis pacientes.',
    rating: 5,
    tag: 'Salud Médica',
    date: 'Hace 3 días'
  },
  ...
  },
  {
    id: 'test_4',
    name: 'Carlos Benítez',
    role: 'Chef Botánico & Sommelier de Té',
    city: 'Santiago, Chile',
